...
Использовались усредненные значения времени по нескольким запускам, тесты проводились на MacOS M3 Pro. Время замерялось с помощью файлика timer.h (с дефайном GET_TIME).
